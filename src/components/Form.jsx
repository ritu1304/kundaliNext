...
const Form = () => {
  ...
  const [latitude, longitude, timezone] = [28.7041, 77.1025, 5.5]; // Example constants for latitude, longitude, and timezone

  const validate = () => {
    const errors = {};
    if (!name) errors.name = 'Name is required!';
    if (!/^[a-zA-Z\s]*$/.test(name)) errors.name = 'Name is invalid!';
            ...
            <div className="card-body">
              <form onSubmit={handleSubmit}>
                ...
                <div className="row">
                  ...
                  <div className="col-6">
                    <div className="form-group">
                      <label className="label_form">Time of Birth</label>
                      <input
                        type="time"
                        className="form-control"
                        value={time}
                ...
                <div className="row">
                  <div className="col-6">
                    <div className="form-group">
                      <label className="label_form">Birth Place</label>
                      <input
                        type="text"
                        className="form-control"
