...
//   const kundliForm = JSON.parse(context.req.cookies.Form);
  
//   var LocalStore = context.req.cookies.lng;
//   var language;
//   if (!LocalStore) {
//     language = "en";
//   } else {
...
//   const res = await fetch(`http://172.31.11.181:5001/kundali/horaChart/LAGNA/en`, OPTIONS);
//   console.log("Lagna house data", res)
//   let houseData = [];
//   if (res.ok) {
//     houseData = await res.json();
//     console.log("Lagna house data", houseData)
//   }
...
// const LagnaChart = ({ houseData = [], language }) => {
//   // if (!houseData.length) {
//   //   return <p>Loading...</p>;
//   // }
...
//             <tspan className = "chartFontSize" x="52%" dy="1.2em">{houseData[0]?.planet_degree[5]}</tspan>
//             <tspan className = "chartFontSize" x="52%" dy="1.2em">{houseData[0]?.planet_degree[6]}</tspan>
//           </text>
//         ))}
//       </g>
//       {/* House 2 */}
...
//             <tspan className = "chartFontSize" x="35%" dy="1.2em">{houseData[0]?.planet_degree[5]}</tspan>
//             <tspan className = "chartFontSize" x="35%" dy="1.2em">{houseData[0]?.planet_degree[6]}</tspan>
//           </text>
//         ))}
//       </g>
//       {/* House 3 */}
...
//             <tspan className = "chartFontSize" x="21%" dy="1.2em">{houseData[2]?.planet_degree[5]}</tspan>
//             <tspan className = "chartFontSize" x="21%" dy="1.2em">{houseData[2]?.planet_degree[6]}</tspan>
//           </text>
//         ))}
//       </g>
//       {/* House 4 */}
...
//             <tspan className = "chartFontSize" x="30%" dy="1.2em">{houseData[3]?.planet_degree[5]}</tspan>
//             <tspan className = "chartFontSize" x="30%" dy="1.2em">{houseData[3]?.planet_degree[6]}</tspan>
//           </text>
//         ))}
//       </g>
//       {/* House 5 */}
...
//             <tspan className = "chartFontSize" x="20%" dy="1.2em">{houseData[4]?.planet_degree[5]}</tspan>
//             <tspan className = "chartFontSize" x="20%" dy="1.2em">{houseData[4]?.planet_degree[6]}</tspan>
//           </text>
//         ))}
//       </g>
//       {/* House 6 */}
...
//             <tspan className = "chartFontSize" x="33%" dy="1.2em">{houseData[5]?.planet_degree[5]}</tspan>
//             <tspan className = "chartFontSize" x="33%" dy="1.2em">{houseData[5]?.planet_degree[6]}</tspan>
...
//             <tspan className = "chartFontSize" x="52%" dy="1.2em">{houseData[6]?.planet_degree[5]}</tspan>
//             <tspan className = "chartFontSize" x="52%" dy="1.2em">{houseData[6]?.planet_degree[6]}</tspan>
...
//             <tspan className = "chartFontSize" x="71%" dy="1.2em">{houseData[7]?.planet_degree[5]}</tspan>
//             <tspan className = "chartFontSize" x="71%" dy="1.2em">{houseData[7]?.planet_degree[6]}</tspan>
...
//             <tspan className = "chartFontSize" x="85%" dy="1.2em">{houseData[8]?.planet_degree[5]}</tspan>
//             <tspan className = "chartFontSize" x="85%" dy="1.2em">{houseData[8]?.planet_degree[6]}</tspan>
...
//             <tspan className = "chartFontSize" x="73%" dy="1.2em">{houseData[9]?.planet_degree[5]}</tspan>
//             <tspan className = "chartFontSize" x="73%" dy="1.2em">{houseData[9]?.planet_degree[6]}</tspan>
...
//             <tspan className = "chartFontSize" x="85%" dy="1.2em">{houseData[10]?.planet_degree[5]}</tspan>
//             <tspan className = "chartFontSize" x="85%" dy="1.2em">{houseData[10]?.planet_degree[6]}</tspan>
...
//             <tspan className = "chartFontSize" x="72%" dy="1.2em">{houseData[11]?.planet_degree[5]}</tspan>
//             <tspan className = "chartFontSize" x="72%" dy="1.2em">{houseData[11]?.planet_degree[6]}</tspan>
...
const LagnaChart = () => {
  ...
  useEffect(() => {
    fetch(`${baseUrl}/kundali/horaChart/LAGNA/${language}`, OPTIONS)
      .then(response => response.json()).then(data => setHouseData(data))
      console.log("Lagna Chart", houseData)
