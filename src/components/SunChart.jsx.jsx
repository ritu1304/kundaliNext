...
const SunChart = () => {
  ...
  useEffect(() => {
    fetch(`http://172.31.11.181:5001/kundali/horaChart/SUN/en`, OPTIONS)
    // fetch(`${baseUrl}/kundali/horaChart/SUN/${language}`, OPTIONS)
      .then(response => response.json()).then(data => setHouseData(data))
      console.log("SUN house data", houseData)
  ...
  return (
    ...
    >
      ...
      <g>
        ...
        />
        <text x="72%" y="71%" dominantBaseline="middle" textAnchor="middle" fill="red">
          {houseData[7]?.sign}
        </text>
        {houseData[7]?.planets.map((planet, planetIndex) => (
          ...
          >
            {/* <tspan className = "chartFontSize">{houseData[0].planetSmall[planetIndex]}</tspan> */}
            <tspan className = "chartFontSize" x="72%" dy="1.2em">{houseData[7]?.planet_degree[0]}</tspan>
            <tspan className = "chartFontSize" x="72%" dy="1.2em">{houseData[7]?.planet_degree[1]}</tspan>
            <tspan className = "chartFontSize" x="72%" dy="1.2em">{houseData[7]?.planet_degree[2]}</tspan>
            <tspan className = "chartFontSize" x="72%" dy="1.2em">{houseData[7]?.planet_degree[3]}</tspan>
            <tspan className = "chartFontSize" x="72%" dy="1.2em">{houseData[7]?.planet_degree[4]}</tspan>
