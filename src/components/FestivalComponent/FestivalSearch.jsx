...
function FestivalSearch({ parentCallback }) {
    ...
    const onchangePlace = (e) => {
        ...
        const OPTIONS = {
            url: `http://172.31.11.181:5001/api/search_festival?festival=${e.target.value}&year=${year}`,
            method: "get",
            headers: {
    ...
    return (
        <>
            <input className="calSearchFestival form-control" type="text" placeholder={t('Enter Festival')} defaultValue={sea_place}  onClear={handleOnClear} value={sea_place} onChange={onchangePlace} />
