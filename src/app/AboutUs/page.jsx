        ...
        <div className="">
          <div className="inspirationBox">
                 {/* <div className="col-sm-1 col-md-1 mt-2"></div> */}
                    ...
                    <div className=" inspText">
                        <h2 className="why_we_start_about ">Inspiration from Guru Ji</h2>
                        <h2 className="guruName">
                            <b>Shree Shree 1008 Mahatma Devsharan Nand ji Maharaj</b>
                        </h2>
                        <span>
                ...
                {/* <div className="shree_krishna"> */}
                <img src="https://sanatanapi-files.s3.ap-south-1.amazonaws.com/static-images/AboutGuruJI.svg" alt="hi" width="80%"/>
                {/* </div> */}
          </div>
          ...
          <div className="row inspirationBox1">
            ...
            <div className="col-sm-6 col-md-12 col-lg-6 bihariJiBg mt-5 mb-5">
              <h2 className="why_we_start_about ">Kindness of Shri Banke Bihari Ji</h2>
          ...
          <div className="row visionBg ">
            <center>
              <h2 className="why_we_start_about">Vision and Mission of Sanatan Jyoti</h2>
