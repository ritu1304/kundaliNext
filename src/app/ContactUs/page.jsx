...
//     const data = await(await ("https://dummyjson.com/users")).json();
//     return{
//     props : {
//       data,
//     },
...
//   export default Contact;
const Contact = async () => {
    const response = await fetch('https://apis.sanatanjyoti.com/api/getFestivalsOnCategory?category=Main&year=2024');
