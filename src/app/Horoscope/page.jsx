...
// import KundaliForm from '../../components/Form'
// const Horoscope = () => {
...
//     const [StoreResp, setStoreResp] = useState(null);
...
//     setLoading(true);
//     try {
//         // Fetch data for the selected zodiac sign
//         const response = await fetch(`/api/getZodiacData?sign=${sign.value}&language=${language}`);
...
//             date: new Date().toLocaleDateString() // or any other date format
//         });
